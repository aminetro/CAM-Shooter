    ...
    public sealed partial class ListPlayer : Page
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                SharedInformation.ListOfPlayers.Add( new Player() {name= rooms[0].player1, color= rooms[0].player1color,number='1',score="0" });

                SharedInformation.ListOfPlayers.Add(new Player() { name = rooms[0].player2, color = rooms[0].player2color, number = '2', score = "0" });

                SharedInformation.ListOfPlayers.Add(new Player() { name = rooms[0].player3, color = rooms[0].player3color, number = '3', score = "0" });

                SharedInformation.ListOfPlayers.Add(new Player() { name = rooms[0].player4, color = rooms[0].player4color, number = '4', score = "0" });
            }
            catch (MobileServiceInvalidOperationException ee)
            {
                exception = ee;
